...
export class ExifResponseDto {
  ...
  @ApiPropertyOptional({ type: 'number', description: 'GPS altitude' })
  altitude?: number | null = null;
  @ApiPropertyOptional({ type: 'number', description: 'GPS direction' })
  direction?: number | null = null;
  @ApiPropertyOptional({ type: 'number', description: 'device yaw' })
  yaw?: number | null = null;
  @ApiPropertyOptional({ type: 'number', description: 'device pitch' })
  pitch?: number | null = null;
  @ApiPropertyOptional({ type: 'number', description: 'device roll' })
